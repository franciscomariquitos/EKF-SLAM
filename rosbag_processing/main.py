#!/usr/bin/env python3
"""Automatic waypoint-mode entry point for the EKF-SLAM micro-simulator."""
...
def main() -> None:
    ...
    if args.runs > 0:
        ...
        plot_monte_carlo_boxplots(rows, outdir, show=not args.no_show)
    ...
    for filename in [
        ...
        "single_run_covariance_map.png",
        "single_run_landmark_convergence.png",
        "single_run_nis.png",
        "single_run_error_heatmap.png",
        "single_run_measurement_diagnostics.csv",
        "single_run_history.csv",
        "monte_carlo_metrics.csv",
        "monte_carlo_boxplots.png",
    ]:
